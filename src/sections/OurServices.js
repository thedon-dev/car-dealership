...
export const OurServices = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[2000px] mx-auto my-10 flex items-center pe-10">
        ...
        <div className="rounded-lg bg-white px-20 py-40 flex flex-col gap-5 w-2/5 -translate-x-10">
